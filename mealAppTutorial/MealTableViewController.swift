...
//  mealAppTutorial
//
//  Created by damian longoria on 10/08/17.
...
class MealTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        // Use the edit button item provider by the table view controller.
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        case "ShowDetail":
            guard let mealDetailViewController = segue.destination as? MealViewController
                    ...
                    fatalError("Unexpected destinatión: \(segue.destination)")
            }
